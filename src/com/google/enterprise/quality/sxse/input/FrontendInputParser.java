...
/**
 * An {@link InputParser} for GSA frontend names.
 */
public class FrontendInputParser implements InputParser<String> {
  ...
  private static final String INVALID_MESSAGE = "Invalid frontend: ";
  private static final ErrorTransformer<StringInputParser.ParseError, ParseError> translator =
      ErrorTransformer.builder(StringInputParser.ParseError.class, ParseError.class)
        .add(
          StringInputParser.ParseError.NO_VALUE, ParseError.NO_VALUE,
          INVALID_MESSAGE)
  ...
  public static final FrontendInputParser INSTANCE = new FrontendInputParser();

  private FrontendInputParser() {
  }
  ...
  /**
   * The parsed input by a {@link FrontendInputParser}.
   */
